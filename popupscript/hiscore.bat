...
REM START OF VARIABLES DECLARATION
    ...
    SET "POPVPMedia=c:\Visual~1\Hiscores\"
...
IF EXIST "%PINemHiHS%\%TEMPTXT%.txt" (
    ...
    REM CALL python "%HiScoreDir%\text_to_video.py" --text_color #ff5820 --text_speed 120 "%PINemHiHS%\%TEMPTXT%.txt" "%OUTPUT%\%~2%Suffix%-new.mp4" "%Video_Font%"
